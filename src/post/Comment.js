                            ...
                            <div key={index}>
                                ...
                                <div>
                                    <Link to={`/user/${comment.postedBy._id}`} >
                                        <img style={{ borderRadius: "50%", border: "1px solid black" }} className="float-left mr-2" width="30px" height="30px" src={`http://localhost:8080/user/photo/${comment.postedBy._id}`} onError={i => (i.target.src = `${DefaultDp}`)} alt={comment.postedBy.name} />
                                    </Link>
                                    <div>
