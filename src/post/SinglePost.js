...
class SinglePost extends Component {
    ...
    renderPost =(post)=>{
        ...
        return (
            ...
            {/* <img style={{height:"200px", width:"auto", borderRadius:"50%", border:"1px solid grey"}} className="img-thumbnail" src={`http://localhost:8080/user/photo/${user._id}`} onError={i=>{i.target.src = `${DefaultDp}`}} alt={user.name}/> */}
            <div className="card-body" >
                <img src={`http://localhost:8080/post/photo/${post._id}`} alt={post.title} onError={i=>i.target.src=`${DefaultPost}`} className="img-thumbnail mb-3" style={{height: 'auto', width: 'auto', objectFit:'cover'}}/>
